...
export function getRandomPhenomenon(excludingId?: string, thinker?: import('@/types/game').Thinker | 'all'): Phenomenon {
  const pool = thinker ? getPhenomenaByThinker(thinker) : PHENOMENA;
